# mobile-qrcode-capture Specification

## Purpose

Defines the in-app camera-based QR code scanner used by the mobile client to capture Brazilian NFC-e fiscal URLs and forward them to the receipt submission flow, including camera permission handling and a manual URL fallback.
## Requirements
